...
public class HashMapDemo_ChocolateFactory {
	...
	public static void main(String[] args) {
		...
		LinkedHashMap box = new LinkedHashMap(); //Insertion order does not maintain. It store sorted by Hashcode and which can be changed as per haskKey
